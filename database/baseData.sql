...
values(1,'weiwei','卫','魏','Weiwei',1,111111,'11122233344','123456','长江西路130号','weiwei@anhuinorthen.com',1,1,null,1,0,'SYSTEM',now(),'SYSTEM',now());
INSERT INTO sec_acc_security (account_id,username,password,effective_date,create_user,create_date,update_user,update_date)
VALUES (1,'weiwei','C4CA4238A0B923820DCC509A6F75849B',now(),'SYSTEM',now(),'SYSTEM',now());
