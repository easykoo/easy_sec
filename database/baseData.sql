...
insert into sec_privilege ( external_id, type,role_id,department_id) values (2,1,3,1);
...
insert into sec_privilege ( external_id, type,role_id,department_id) values (3,1,3,1);
...
insert into sec_privilege ( external_id, type,role_id,department_id) values (11,1,3,1);
